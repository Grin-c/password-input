...
const buttonInput = document.querySelector(".confirm input")

passInput.addEventListener("input", handlePassInput);
toggleIcon.addEventListener("click", togglePassInput);
buttonInput.addEventListener("click", redirectSite);

function redirectSite(e) {
    console.log(passInput.value.toLowerCase())
    if (passInput.value.toLowerCase() === "yasmim") {
